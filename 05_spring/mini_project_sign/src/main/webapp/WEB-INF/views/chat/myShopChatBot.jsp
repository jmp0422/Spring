...
<script type="text/javascript"
	src="${pageContext.servletContext.contextPath }/resources/js/sockjs-0.3.4.js"></script>

<script type="text/javascript" src="${pageContext.servletContext.contextPath }/resources/js/stomp.js"></script>
<script type="text/javascript"
	src="${pageContext.servletContext.contextPath }/resources/js/webSocketSendToUserApp.js"></script>
<script type="text/javascript">
...
<body onload="connect();">
	<br>
	<br>
	<img src=${pageContext.servletContext.contextPath }/resources/img/chat1.png width=100 height=100>
	<img src=${pageContext.servletContext.contextPath }/resources/img/chat3.png width=400 height=100>
